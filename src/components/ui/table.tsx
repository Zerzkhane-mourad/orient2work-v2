...
export function TH({ className, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <th
      className={cn(
        "px-4 py-3 text-xs font-bold uppercase tracking-wider text-on-surface-variant",
        className,
      )}
      {...props}
    />
...
export function TR({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) {
  return (
    <tr className={cn("transition-colors hover:bg-surface-container-low", className)} {...props} />
  );
}
